                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if (imagePath != null && imagePath.isNotEmpty) {
                                ...
                                imageUrl = 'https://backend.zenzio.in$imagePath';
                              }
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          // ✅ Show available events and times
...
//   @override
//   Widget build(BuildContext context) {
//     // ✅ Cuisine filter (dummy filter now)
//     final cuisineOptions = ['All', 'Italian', 'Asian', 'Mexican', 'Indian'];
...
//                       // ✅ Fix: some images have wrong path (/root/...), fix with base URL
//                       String? imageUrl;
//                       if (imagePath != null && imagePath.isNotEmpty) {
//                         imagePath = imagePath.replaceAll(
//                           '/root/choozy-backend',
...
//                                           '/booking-detail',
//                                           arguments:
//                                               restaurant['id'], // 👈 Pass only the restaurant ID
//                                         );
//                                       },
