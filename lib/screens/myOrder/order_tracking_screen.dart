...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  void initState() {
    ...
    // Simulate order delivery after 5 seconds (for demo)
    // Remove this in production - use real-time order status
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => OrderRatingScreen(
          orderId: widget.orderId ?? 'ORDER_123',
        ),
      ),
    );
  }
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  if (_isDelivered) const SizedBox(height: 12),
