...
class CartService {
  ...
  Future<List<CartItem>> fetchCartItems() async {
    final response = await _api.get(ApiConfig.cartEndpoint, requiresAuth: true);
  ...
  //  GET CART DETAILS WITH cart_group_uid
  // ============================
  ...
  //  GET CART GROUP BY RESTAURANT UID
  // ============================
  ...
  // CLEAR SPECIFIC RESTAURANT CART GROUP
  // ============================
